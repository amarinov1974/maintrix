...
export function AMMCostEstimationTicketsPage() {
    ...
    return (_jsxs(Layout, { screenTitle: "Prijave \u2014 \u010Deka procjena tro\u0161ka", children: [_jsxs("div", { className: "max-w-4xl mx-auto space-y-4", children: [_jsxs("div", { className: "flex flex-wrap items-center justify-between gap-4", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-2xl font-bold text-gray-900", children: "Tickets Awaiting Cost Estimation" }), _jsx("p", { className: "text-sm text-gray-600 mt-0.5", children: "Non-urgent tickets in Cost Estimation Needed, owned by you \u2014 newest first" })] }), _jsx(Link, { to: "/amm", children: _jsx(Button, { type: "button", variant: "secondary", children: "Natrag na nadzornu plo\u010Du" }) })] }), isLoading ? (_jsx("p", { className: "text-gray-500", children: "Loading\u2026" })) : costEstimationTickets.length === 0 ? (_jsx("div", { className: "rounded-lg border border-gray-200 bg-gray-50 p-6 text-center text-gray-600", children: "Nema prijava koje \u010Dekaju procjenu tro\u0161ka." })) : (_jsx("ul", { className: "space-y-2", children: costEstimationTickets.map((ticket) => (_jsx("li", { children: _jsx(TicketPreviewRow, { ticket: ticket, onOpen: () => setSelectedTicketId(ticket.id) }) }, ticket.id))) }))] }), selectedTicketId != null && (_jsx(AMMTicketDetailModal, { ticketId: selectedTicketId, onClose: () => setSelectedTicketId(null) }))] }));
}
